...
const BLOG = {
  ...
  CONTACT_EMAIL: 'tg1326915992@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'myLazyProgrammer/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  // 无关紧要的配置
  AVATAR: 'https://avatars.githubusercontent.com/u/28853627?s=400&u=fe0db4180c30842a8d966ade7495100f40543dc1&v=4', // 作者头像，被notion中的ICON覆盖。如果没有ICON则取public目录下的avatar.png
